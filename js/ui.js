...
var SCAYTOptionsDialog = {
	...
	init : function(editor) {
		...
		var mode = tinyMCEPopup.editor.settings.scaytDialogMode;
	...
	renderTabsBar: function(){
		var uiTabs = tinyMCEPopup.editor.settings.scayt_ui_tabs.split(",");
...
tinyMCEPopup.onInit.add(SCAYTOptionsDialog.init, SCAYTOptionsDialog);
			...
			var scayt_control = tinymce.editors[tinyMCEPopup.editor.id].plugins["scayt"].instances[tinyMCEPopup.editor.id];
						...
						get.forEach(lang_arr , function( l , i ){
							...
							row_dom.bindOnclick(function(ev){
								...
								window.setTimeout( function (){ 
										get.byId(elId).setStyle({color:"#636363",cursor:"no-drop"});  
									} 
								,300 );
								...
								get.byId(chosed_lang.split("::")[1])
									...
									.removeClass("Button")
									.setStyle({color:"#000000",cursor:"pointer"});
							...
							// select current lang
							if (l == chosed_lang)
								row_dom.addClass("Button").setStyle({color:"#636363",cursor:"no-drop"});
							else 
